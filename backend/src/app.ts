...
const teamRoutes = require('./routes/teamFormation.route');
const managerInfoRoutes = require('./routes/fieldManagerInformation.route');
const adminInfoRoutes = require('./routes/adminInformation.route');
